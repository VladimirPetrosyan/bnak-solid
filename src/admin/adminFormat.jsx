...
export function PersonLine(props) {
  return (
    <div>
      ...
      <Show when={props.person} fallback={<div style="margin-top:4px;font-size:14px;color:#9a9793">—</div>}>
        <div style="margin-top:4px;font-size:14px;font-weight:700">{props.person.name || 'Без имени'}</div>
