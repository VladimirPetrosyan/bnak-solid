    ...
    <>
      ...
      <Show when={rows().length === 0}>
        <div style="margin-top:20px;background:#fff;border-radius:20px;padding:clamp(28px,5vw,48px);text-align:center;box-shadow:0 1px 2px rgba(28,27,25,.05)">
          ...
          <div style="font-size:15px;color:#6f6d68;margin-top:8px">{t().noListingsS}</div>
          <button
            type="button"
            class="bn-tap"
            onClick={() => go('post')}
          ...
          {(r) => (
            ...
            >
              ...
              <div style="flex:1 1 200px;min-width:0">
                <span
                  style={`display:inline-flex;align-items:center;padding:8px 12px;border-radius:999px;font-size:12px;font-weight:700;background:${r.chipBg()};color:${r.chipFg()}`}
                >
                  {r.chipText()}
                </span>
                <Show when={r.hasPendingRevision()}>
                  <span
                    style={`display:inline-flex;align-items:center;gap:6px;margin-left:8px;padding:8px 12px;border-radius:999px;font-size:12px;font-weight:700;background:${TEAL_T};color:${TEAL_TX}`}
                  >
                ...
                <button
                  ...
                  style="display:block;width:100%;text-align:left;font-size:16px;font-weight:700;margin-top:8px"
                >
                ...
                <div style="display:flex;gap:20px;margin-top:12px;font-size:13px;color:#6f6d68;flex-wrap:wrap">
                  <span>
              ...
              <div style="flex:1 1 100%;display:flex;gap:8px;flex-wrap:wrap;margin-top:4px">
                <button
                  ...
                  class="bn-tap"
                  onClick={r.act}
                  style={`flex:1 1 160px;display:flex;align-items:center;justify-content:center;padding:12px 16px;border-radius:12px;font-size:14px;font-weight:700;background:${r.btnBg()};color:${r.btnFg()};border:1px solid ${r.btnBd()}`}
                >
                  {r.btnLabel()}
                </button>
                <button
