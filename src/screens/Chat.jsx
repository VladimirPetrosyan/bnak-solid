...
const plainBtn =
  'width:36px;height:36px;border-radius:999px;display:flex;align-items:center;justify-content:center;background:transparent;cursor:pointer;flex:0 0 auto';
const attachRowStyle =
  'display:flex;align-items:center;gap:12px;padding:10px 12px;border-radius:12px;cursor:pointer;font-size:13.5px;font-weight:600;color:#1c1b19';
            ...
            <div style="padding:16px 20px;border-bottom:1px solid #f0efec;display:flex;gap:12px;align-items:center;flex:0 0 auto">
              <Show when={state.isMob}>
                <div
                  ...
                  style="width:34px;height:34px;flex:0 0 auto;border-radius:11px;display:flex;align-items:center;justify-content:center;background:#f7f7f6;cursor:pointer;margin-right:-4px"
                >
              ...
              <Show when={listing()}>
                <div
                  ...
                  style="padding:8px 12px;border-radius:11px;background:#f2f1ee;font-size:12.5px;font-weight:700;cursor:pointer;white-space:nowrap"
                >
                  {t().listingW}
                </div>
              </Show>
                    ...
                    <For each={['q1', 'q2', 'q3']}>
                      {(key) => (
                        <div
                          ...
                          style="padding:8px 12px;border-radius:999px;border:1px solid #e8e7e4;font-size:12.5px;font-weight:600;cursor:pointer"
                        >
                          {txt(key)}
                        </div>
                      )}
                ...
                >
                  ...
                  <Show when={!thread().support}>
                    <div style="position:relative;flex:0 0 auto">
                      <div title={t().attachTitle} onClick={toggleAttach} style={`${plainBtn};color:#6f6d68`}>
                      ...
                      <Show when={attachOpen()}>
                        ...
                        >
                          <div onClick={pickImage} style={attachRowStyle}>
                            <AttachIcon name="image" bg={TEAL_T} fg={TEAL} />
                            {t().attachPhoto}
                          </div>
                          <div onClick={pickVideo} style={attachRowStyle}>
                            <AttachIcon name="video" bg={TEAL_T} fg={TEAL} />
                            {t().attachVideo}
                          </div>
                          <div onClick={pickDoc} style={attachRowStyle}>
                            <AttachIcon name="doc" bg={SOFT} fg="#4a4844" />
                            {t().attachDoc}
                          </div>
                          <div onClick={shareLocation} style={attachRowStyle}>
                  ...
                  >
                    <div style="position:relative;flex:0 0 auto">
                      <div title={t().emojiTitle} onClick={toggleEmoji} style={`${plainBtn};color:#8f8b85`}>
                          ...
                          <For each={EMOJI}>
                            {(e) => (
                              <div
                                ...
                                style="display:flex;align-items:center;justify-content:center;font-size:20px;padding:4px;border-radius:8px;cursor:pointer"
                              >
                                {e}
                              </div>
                            )}
                    ...
                    <Show
                      ...
                      fallback={
                        <div title={t().micTitle} onClick={voice.start} style={`${plainBtn};color:${TEAL}`}>
                          <Icon name="mic" size={20} weight={1.8} />
                        </div>
                      }
                    >
                      <div title={t().sendW} onClick={sendMsg} style={`${plainBtn};color:${TEAL}`}>
              ...
              <Show when={voice.recording()}>
                ...
                >
                  <div
                    ...
                    style="width:44px;height:44px;border-radius:14px;display:flex;align-items:center;justify-content:center;background:#f2f1ee;color:#93331f;cursor:pointer;flex:0 0 auto"
                  >
                  ...
                  <div
                    ...
                    style={`width:44px;height:44px;border-radius:14px;display:flex;align-items:center;justify-content:center;background:${TEAL};color:#fff;cursor:pointer;flex:0 0 auto`}
                  >
